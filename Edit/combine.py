...
TEXT_TO_SPEAK = "Testing the whispers subtitle methods. These methods use whispers AI to get a more accurate duration for each word in the text."  # Text you want to convert to speech
...
def main():
    ...
    merge_audio("testing_audio.mp3", "temp_vid.mp4", "testing_video.mp4")
